...
Самый показательный пример, зачем сравнивать человека с самим собой — пати. По всем играм скопом пати и соло выглядят одинаково. А если взять ваши пати против ваших соло, в пати вы выигрываете на 1.0% реже. Разница прячется, потому что в пати чаще заходят люди сильнее среднего.
...
## Одна медаль — разная сила: кто играет в 4600–5000

Один и тот же номер 4600–5000 или медаль Divine 4–5 не значит, что люди играют одинаково. OpenDota часто рисует Divine 4–5 как 4200–4500, поэтому в пул берём и оценку MMR, и саму медаль. В этой полосе кто-то плюсует и доминирует на линии, кто-то минусует и умирает чаще. Мы взяли публичные ranked-истории за последние 60 дней, оставили тех, у кого накопилось хотя бы 25 каток, и разрезали на слабых (нижние 25%) и сильных (верхние 25%) по тому, как они реально играют: винрейт, золото в минуту, опыт, отношение убийств к смертям.

Дальше сравнивается не медаль, а режим жизни: сколько каток в неделю, длинные ли вечера, ночь это или прайм по Москве.

В наблюдение попали 942 аккаунтов из Divine-лобби. В полосе 4600–5000 / Divine 4–5 осталось 169, достаточно свежих игр — у 109. Пустых или закрытых историй на этом пути — 56: эти люди могут жить иначе, чем открытые.

| Что смотрим | Слабые в этом пуле | Середина | Сильные в этом пуле |
| --- | --- | --- | --- |
| Игроков | 28 | 53 | 28 |
| Каток в неделю | 15.7 | 16.5 | 16.6 |
| Каток за один вечер | 3.6 | 3.0 | 3.3 |
| Ночные катки, 0–5 МСК | 21% | 20% | 22% |
| Прайм, 18–22 МСК | 20% | 30% | 28% |
| Выходные | 41% | 35% | 29% |
| Винрейт за 60 дней | 48.2% | 51.9% | 59.0% |
| Золото в минуту | 418 | 514 | 600 |

Простыми словами: частота и длина вечеров почти те же. Отличие — в выходные сильные играют на 12% реже.
Совпало: сколько каток в неделю, длина вечера, ночь 0–5 МСК, прайм 18–22 МСК.

Это не «подкрутка» и не закон вселенной. Это снимок публичных аккаунтов одной полосы: кто в ней выглядит слабее, а кто сильнее, и совпадает ли это с тем, *когда* они садятся в поиск. Если игроков мало (здесь слабых 28, сильных 28), разница в часах может быть шумом. Повторять стоит на большей выборке.

![Когда заходят слабые и сильные одной полосы](figures/bracket_activity.png)

## Остальные теории матчмейкинга

Жёсткая 50%, отдельные очереди по серии и наказание составом после побед уже разобраны выше. Здесь — всё остальное, что люди рассказывают про подбор. Предсказания зафиксированы в [THEORIES.md](../THEORIES.md) до расчёта.

Большинство этих легенд либо не держатся, либо это открытые правила Valve, либо в OpenDota такого поля нет.

| Что говорят | Что вышло | Простыми словами |
| --- | --- | --- |
| В пати лобби жёстче | лобби на +0.43 ранга выше | Так и задумано: Valve открыто ставит пати более сильных.  Штраф к победе после учёта ранга лобби на 1.1% реже. |
| После красивого слива следующее лобби жёстче | разница -0.13 ранга | Следующее лобби ниже, не выше. Красивый проигрыш не делает катку жёстче — легенда предсказывала обратное. |
| На чужом сервере вас специально сливают | вы выигрываете на 0.2% чаще | Шанс тот же. Серверы мешаются, но это не подкрутка исхода. |
| На чужой роли катки невыездные | вы выигрываете на 0.6% реже, лобби +0.34 | Чужую роль узнаём по герою (саппорт против ядра), не по кнопке поиска. Выигрываете чуть реже, а лобби даже чуть выше — не «лёгкие катки за не свою роль». |
| Худших троих всегда в одну команду | избыток -0.030 на 641 составах | Худшие трое вместе не чаще, чем наугад. Легенда не держалась. |
| Смурфы сидят в своём пуле | избыток пар +0.000, меток 121 | Отдельный пул здесь не виден. Помеченных смурфов мало, ячейки почти не смешиваются. |
| Ночью лобби грязнее, потому что поиск дольше | разброс ранга -0.185 | Ночной разброс почти как дневной. Либо пул густой, либо прокси слабый: времени в очереди в данных нет. |
| В выходные лобби грязнее | разброс ранга -1.154 | В выходные коридор уже, не шире. «Выходной пул грязнее» не держалась. |
| Калибровка навсегда сажает номер | 57% сменили десяток рейтинга после 30-й игры, медианный сдвиг 5.8 | Номер после раннего окна ещё ездит. «Навсегда сел» не сходится. |
| Патч 7.33 раздул рейтинг | средний average_rank +6.21 | Сдвиг сетки после большого патча — не подкрутка конкретного матча. |
| После перерыва вас кидает не туда | сдвиг лобби +1.13 | После длинной паузы лобби сильнее прыгает. Так и должна работать неопределённость рейтинга, это не подкрутка. |
| В рейтинге есть второй секретный MMR | связь видимого MMR и лобби 0.43 (остаток 14.76, n=200) | Связь есть, но шкалы разные (MMR — тысячи, лобби — десятки), остаток большой. Второй секретный рейтинг здесь не доказали и не опровергли. |
| Медаль и лобби — разные миры | у 75% игроков последние 20 лобби отличаются от длинного номера на 3+ ранга | Так бывает и без второго MMR: патчи, паузы, смена роли. |
...
![Остальные теории](figures/theories.png)
...
| G_bracket | night_diff | 0.01087 | — | 56 | доля ночных каток (МСК 0–5): сильный минус слабый |
| G_bracket | per_week_diff | 0.93750 | — | 56 | каток в неделю: сильный минус слабый |
| H_theories | away_cluster_win | 0.00226 | -0.0006 … 0.0051 | 1,314,065 | победа на чужом сервере |
| H_theories | cal_median_move | 5.78200 | — | 1,231 | медианный |сдвиг| average_rank после раннего окна |
| H_theories | cal_share_changed | 0.56621 | — | 1,231 | доля сменивших десяток рейтинга после 30-й игры |
| H_theories | lobby_spread_night | -0.18496 | -0.9142 … 0.5443 | 191 | разброс rank_tier ночью минус днём |
| H_theories | lobby_spread_weekend | -1.15379 | -1.7548 … -0.5528 | 585 | разброс rank_tier в выходные минус будни |
| H_theories | mmr_lobby_corr | 0.42778 | — | 200 | связь computed_mmr и лобби последних 20 |
| H_theories | next_lobby_after_good_loss | -0.13474 | -0.1699 … -0.0995 | 635,927 | лобби после красивого слива минус после слабого |
| H_theories | off_role_lobby | 0.34201 | 0.2794 … 0.4046 | 1,314,065 | лобби на чужой роли |
| H_theories | off_role_win | -0.00571 | -0.0100 … -0.0014 | 1,314,065 | победа на чужой роли |
| H_theories | party_lobby | 0.42781 | 0.0410 … 0.8146 | 384,167 | лобби в пати минус соло, у того же человека |
| H_theories | party_win_controlled | -0.01074 | -0.0177 … -0.0038 | 384,167 | победа в пати после контроля на ранг лобби |
| H_theories | patch_rank_shift | 6.20655 | — | 19,921 | сдвиг среднего average_rank после 7.33 |
| H_theories | returning_abs_delta | 1.12727 | 0.9694 … 1.2851 | 3,867 | |сдвиг лобби| после паузы ≥30 дней |
| H_theories | smurf_mirror_excess | 0.00027 | — | 116 | зеркало смурфов минус рассадка |
| H_theories | smurf_pool_excess | 0.00000 | 0.0048 … 0.0048 | 1,146 | пары смурф–смурф минус нуль |
| H_theories | weak_three_excess | -0.03005 | — | 641 | трое слабых на одной стороне минус перестановка |
