...
| -2 | 237 | -0.272 ± 0.306 |
| -1 | 248 | +0.071 ± 0.264 |
| +0 | 1 | -4.232 ± нет данных |
| +1 | 272 | +0.372 ± 0.216 |
| +2 | 227 | -0.128 ± 0.260 |
| +3 | 225 | +0.272 ± 0.259 |

Наклон перекоса по серии: +0.04444 (SE 0.08720). Подкрутка требует значимо отрицательного значения.

Ограничение теста: в среднем 5% участников матча скрывают профиль, и их сила ненаблюдаема.
...
Собственный перформанс игрока растёт вместе с серией: +0.00306 стандартного отклонения за шаг. Это означает, что зависимость исхода от серии в значительной мере порождается самим человеком, а не подбором соперников.
...
Проверка на заведомых случаях (молодые аккаунты, добравшиеся до Divine, против аккаунтов с многолетней стабильной историей) даёт AUC 0.845. AUC разделения заведомых смурфов и жителей рейтинга; без возрастной компоненты 0.805.
